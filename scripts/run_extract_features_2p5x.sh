...
target_magnification="${TARGET_MAGNIFICATION:-2.5}"
...
timing_dir="${RESULTS_ROOT}/stage_timing"
timing_path="${timing_dir}/feature_extraction_2p5x.json"
mkdir -p "${timing_dir}"
