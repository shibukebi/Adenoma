...
CONFIG_PATH="${CONFIG_PATH:-${PROJECT_ROOT}/config/clam_ssl_5x_clam_sb.env}"
...
"${CLAM_PYTHON}" "${PROJECT_ROOT}/scripts/summarize_clam_ssl_experiment.py" \
  ...
  --baseline-results-dir /data15/data15_5/yuexin2/adenoma/outputs/clam_ssl_vs_others_2p5x_clam_sb_rerun_20260420_233727/fold-0 \
  --baseline-results-dir /data15/data15_5/yuexin2/adenoma/outputs/clam_ssl_vs_others_20x_clam_sb_rerun_20260421_110952/fold-0 \
